...
class RewardsCfg:
    ...
    track_heading_command_exp = RewTerm(
        func=mdp.track_heading_command_exp,
        weight=0.0,
        params={"command_name": "base_velocity", "std": 0.6, "lin_vel_threshold": 0.2},
    )
    ...
    feet_flight_penalty = RewTerm(
        func=mdp.feet_flight_penalty,
        weight=0.0,
        params={
            "command_name": "base_velocity",
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names=""),
