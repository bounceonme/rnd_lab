...
def apply_step_flat_stable_walk_rewards(env_cfg) -> None:
    ...
    env_cfg.rewards.lateral_lin_vel_x_yaw_l2 = RewTerm(func=mdp.lateral_lin_vel_x_yaw_l2, weight=-0.4)
    ...
    env_cfg.rewards.feet_min_lateral_distance_x_l2 = RewTerm(
        ...
        weight=-2.5,
        params={
            # Foot mesh lateral width is about 0.095 m, so 0.165 m leaves roughly 7 cm of inner clearance.
            "min_width": 0.165,
